...
This is a simple and sleek shopping cart application built using **Next.js** and **Tailwind CSS**. The application features a modern UI for adding, removing, and managing products in a cart, with a focus on responsive design, smooth user interactions, and robust state management.

## Features

- **Responsive Design**: Optimized for both mobile and desktop views.
- **Product Management**: Add, remove, and update quantities of items in the cart.
- **Cart Summary**: Real-time calculation of subtotal, discount, and total amount.
- **Coupon Code Input**: Apply discounts using coupon codes with a modern, sleek input field.
- **State Management with Redux Toolkit**: Efficient and scalable state management using Redux Toolkit.
...
- **Bottom Sheet Cart Summary**: A mobile-friendly bottom sheet for viewing the cart summary.
...
- **React Icons**: For adding scalable vector icons that seamlessly integrate with the UI.
